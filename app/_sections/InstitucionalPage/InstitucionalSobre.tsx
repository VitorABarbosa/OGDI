      ...
      <div className="wrap relative z-10">
        <div className="grid grid-cols-1 items-start gap-[clamp(40px,6vw,100px)] lg:grid-cols-[0.82fr_1.18fr]">
          <div className="reveal">
            ...
            <h2 className="mt-[18px] font-sans font-semibold text-[clamp(1.6rem,2.5vw,2.3rem)] leading-[1.07] tracking-[-.03em] text-ink">
              {t.rich("heading", {
                br: () => <br />,
          ...
          <div className="reveal reveal-2 [&_p]:mb-5 [&_p]:max-w-[62ch] [&_p]:text-justify [&_p]:text-[clamp(15px,1.25vw,18px)] [&_p]:leading-[1.72] [&_p]:text-ink-2 [&_p:last-child]:mb-0 [&_.em]:font-medium [&_.em]:text-ink">
