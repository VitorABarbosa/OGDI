...
export const projetos: Projeto[] = [
  ...
  {
    cat: "futuro", status: "Futuro lançamento", name: "Jabaquara",
    slug: "jabaquara",
    image: "/assets/projetos/OGDI_FUTURO_LANCAMENTO_HORIZONTAL.png",
    imagePortrait: "/assets/projetos/OGDI_FUTURO_LANCAMENTO_RETRATO.png",
    tag: "Oportunidade originada e operação em estruturação.",
    tone: "t3", ctaLabel: "Falar sobre o projeto",
    segmento: "Residencial", local: "Jabaquara · SP",
    modelo: "Sócia da operação",
    closingStatement: {},
    gallery: [
      { id: "jabaquara-g1", alt: "Fachada / render principal" },
      { id: "jabaquara-g2", alt: "Render vertical" },
      { id: "jabaquara-g3", alt: "Área comum" },
      { id: "jabaquara-g4", alt: "Apartamento decorado" },
      { id: "jabaquara-g5", alt: "Detalhe arquitetônico" },
      { id: "jabaquara-g6", alt: "Render panorâmico / implantação" },
    ],
  },
  {
