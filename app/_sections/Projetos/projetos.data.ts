...
export const projetos: Projeto[] = [
  { cat: "obra", status: "Em obra", name: "Hits Cupecê", tag: "Operação estruturada na origem, do produto ao lançamento.", tone: "t2", ctaLabel: "Conheça o empreendimento", href: "/#contato", image: "/assets/projetos/CUPECE/Cupece.png" },
  { cat: "obra", status: "Em obra", name: "Start Park Jabaquara", tag: "Da inteligência de mercado à condução até o lançamento.", tone: "t3", ctaLabel: "Conheça o empreendimento", href: "/#contato", image: "/assets/projetos/HITS_START_PARK_JABAQUARA/HITS_PARK.png" },
  { cat: "obra", status: "Em obra", name: "Oh Freguesia", tag: "Produto conceituado e operação estruturada pela OGDI.", tone: "t1", ctaLabel: "Conheça o empreendimento", href: "/#contato", image: "/assets/projetos/OH_FREGUESIA/Oh_freguesia.png" },
